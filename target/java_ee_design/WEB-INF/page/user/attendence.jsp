...
<div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
    ...
    <main class="mdl-layout__content mdl-color--grey-100">
        <table class="mdl-data-table mdl-js-data-table mdl-shadow--2dp"
               style="margin-top: 20px;margin-left: 5%;width: 90%;" id="attendence">
            <thead>
            <tr>
                <th>节次</th>
                <th>星期一</th>
        ...
        <div id="attendenceDetail">
            <table class="mdl-data-table mdl-js-data-table mdl-shadow--2dp"
                   style="margin-top: 20px;margin-left: 5%;width: 90%;" id="unattendenceList" ng-controller="freshList">
                <thead>
                <tr>
                    <th>排课编号</th>
                        ...
                        <td>
                            <md-input-container>
                                <md-select placeholder="studentId" ng-model="studentId">
                                    <md-option ng-repeat="studentId in studentIds" value="{{studentId}}">{{studentId}}
                                    </md-option>
                                </md-select>
                            </md-input-container>
                        </td>
        ...
        <div id="chart" style="display: none;margin-top: 20px;margin-left: 100px" ng-controller="getChart">
            <div id="lineChart" style="width: 400px; height: 300px">
